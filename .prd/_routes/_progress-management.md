...
### v4 - 2026-05-14
- 移除左侧功能菜单（FunctionMenu），形象进度管理和合同收付款确认为独立页面
- 通过左侧主菜单直接切换显示

### v3 - 2026-05-14
- 删除了项目信息栏（ProjectInfoBar）和流程节点导航栏（ProcessFlowBar）
- 左侧菜单改为直接切换"形象进度管理"和"合同收付款确认"两个页面

### v2 - 2026-05-14
- 新增左侧菜单入口，作为一级菜单项独立展示
