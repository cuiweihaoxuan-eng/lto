...
| 合计金额 | 金额 | - | 自动计算 | 系统计算 | NVR×100+点位数×100+月份×3 | 显示 | 只读 |
...
| 合计金额 | 金额 | - | 自动计算 | 系统计算 | 9U×200+22U×400+42U×800+1U×80+信息点×25 | 显示 | 只读 |
...
| 总人工费 | 金额 | 是 | - | 用户输入 | 正数 | 数字输入框 | 可编辑 |
| 结算金额 | 金额 | - | 自动计算 | 系统计算 | 总人工费×0.4 | 显示 | 只读 |
