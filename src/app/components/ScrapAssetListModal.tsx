...
interface ScrapAssetListModalProps {
  open: boolean;
  onClose: () => void;
  assets: FixedAsset[];
}

export function ScrapAssetListModal({ open, onClose, assets }: ScrapAssetListModalProps) {
  if (!open) return null;
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl mx-4 max-h-[80vh] flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between flex-shrink-0">
          <h3 className="text-lg font-medium text-gray-900">报废资产清单</h3>
