...
const mockData: PersonListItem[] = [
  { id: "1", index: 1, businessUnit: "杭州分公司", branch: "西湖支局", personName: "张三", phone: "138****1234", empNo: "EMP001", dept: "西湖支局-销售部", settlementName: "2026年4月自交付结算", settlementCode: "JSD202604001", status: "审核中", settlementAmount: "2,500.00", businessType: "项目型", businessCode: "HT202604001", applicant: "张明", applyTime: "2026-04-15 10:30" },
  { id: "2", index: 2, businessUnit: "杭州分公司", branch: "西湖支局", personName: "李四", phone: "138****2345", empNo: "EMP002", dept: "西湖支局-销售部", settlementName: "2026年4月自交付结算", settlementCode: "JSD202604001", status: "审核中", settlementAmount: "2,800.00", businessType: "项目型", businessCode: "HT202604001", applicant: "张明", applyTime: "2026-04-15 10:30" },
  { id: "3", index: 3, businessUnit: "杭州分公司", branch: "西湖支局", personName: "王五", phone: "138****3456", empNo: "EMP003", dept: "西湖支局-销售部", settlementName: "2026年4月自交付结算", settlementCode: "JSD202604001", status: "审核中", settlementAmount: "2,700.00", businessType: "项目型", businessCode: "HT202604001", applicant: "张明", applyTime: "2026-04-15 10:30" },
  { id: "4", index: 4, businessUnit: "杭州分公司", branch: "西湖支局", personName: "张三", phone: "138****1234", empNo: "EMP001", dept: "西湖支局-销售部", settlementName: "2026年3月自交付结算", settlementCode: "JSD202603001", status: "已发放", settlementAmount: "2,500.00", businessType: "项目型", businessCode: "HT202604001", applicant: "张明", applyTime: "2026-03-15 14:20" },
  { id: "5", index: 5, businessUnit: "杭州分公司", branch: "西湖支局", personName: "李四", phone: "138****2345", empNo: "EMP002", dept: "西湖支局-销售部", settlementName: "2026年3月自交付结算", settlementCode: "JSD202603001", status: "已发放", settlementAmount: "2,500.00", businessType: "项目型", businessCode: "HT202604001", applicant: "张明", applyTime: "2026-03-15 14:20" },
  { id: "6", index: 6, businessUnit: "宁波分公司", branch: "鄞州支局", personName: "赵六", phone: "138****4567", empNo: "EMP004", dept: "鄞州支局-销售部", settlementName: "2026年4月自交付结算", settlementCode: "JSD202604002", status: "已发放", settlementAmount: "3,000.00", businessType: "小微标品", businessCode: "WO202604001", applicant: "李华", applyTime: "2026-04-10 09:15" },
  { id: "7", index: 7, businessUnit: "宁波分公司", branch: "鄞州支局", personName: "钱七", phone: "138****5678", empNo: "EMP005", dept: "鄞州支局-销售部", settlementName: "2026年4月自交付结算", settlementCode: "JSD202604002", status: "已发放", settlementAmount: "3,000.00", businessType: "小微标品", businessCode: "WO202604001", applicant: "李华", applyTime: "2026-04-10 09:15" },
  { id: "8", index: 8, businessUnit: "台州分公司", branch: "椒江支局", personName: "孙八", phone: "138****6789", empNo: "EMP006", dept: "椒江支局-销售部", settlementName: "2026年5月自交付结算", settlementCode: "JSD202605001", status: "审核中", settlementAmount: "4,500.00", businessType: "小微标品", businessCode: "WO202604005", applicant: "王九", applyTime: "2026-05-10 11:00" },
  { id: "9", index: 9, businessUnit: "温州分公司", branch: "鹿城支局", personName: "周十", phone: "138****7890", empNo: "EMP007", dept: "鹿城支局-销售部", settlementName: "2026年4月自交付结算", settlementCode: "JSD202604003", status: "审核通过", settlementAmount: "4,000.00", businessType: "三联单", businessCode: "DD202604001", applicant: "刘十一", applyTime: "2026-04-20 15:30" },
  { id: "10", index: 10, businessUnit: "温州分公司", branch: "鹿城支局", personName: "吴一", phone: "138****8901", empNo: "EMP008", dept: "鹿城支局-销售部", settlementName: "2026年4月自交付结算", settlementCode: "JSD202604003", status: "审核通过", settlementAmount: "4,000.00", businessType: "三联单", businessCode: "DD202604001", applicant: "刘十一", applyTime: "2026-04-20 15:30" },
  { id: "11", index: 11, businessUnit: "温州分公司", branch: "鹿城支局", personName: "郑二", phone: "138****9012", empNo: "EMP009", dept: "鹿城支局-销售部", settlementName: "2026年4月自交付结算", settlementCode: "JSD202604003", status: "审核通过", settlementAmount: "4,000.00", businessType: "三联单", businessCode: "DD202604001", applicant: "刘十一", applyTime: "2026-04-20 15:30" },
];
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              ...
              {filteredData.length === 0 && (
                <tr><td colSpan={15} className="px-3 py-8 text-center text-gray-500">暂无数据</td></tr>
              )}
            </tbody>
          </table>
        </div>
